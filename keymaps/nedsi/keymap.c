...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MED] = LAYOUT_wrapper( 
    ________________MED_L1________________,                                ________________MED_R1________________,
    ________________MED_L2________________,                                ________________MED_R2________________,
    ________________MED_L3________________,                                ________________MED_R3________________,
                        _______, _______, _______,                      _______, _______, _______
    )
};
